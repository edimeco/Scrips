...
outdir = "/data9Vd1/padme/dimeco/outSig_periodo"
...
mclist = commands.getstatusoutput("gfal-ls "+runpath+ " | grep sig_20240517")[1]
mclist=mclist.split('\n')
...
for ip,periodo in enumerate(mclist):
    print(periodo)
    print('sig_20240517_{}'.format(runs[ip]))

    #if ip<10:  #periodo.startswith(periodo): #periodo.startswith('sig_20240517_{}'.format(runs[ip])) or
        
    lsCommand = "gfal-ls "+runpath+periodo+"/rec/repro20240522"
